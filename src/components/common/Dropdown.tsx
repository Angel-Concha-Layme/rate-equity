...
/** Select custom (no nativo), alineado al tema. Teclado: flechas, Enter, Home/End, Escape. */
    ...
    <div ref={ref} className={cn("relative", className)}>
      ...
      {open &&
        ...
        <ul
          ...
          className="max-h-64 animate-fade-up overflow-auto rounded-input border border-line bg-surface p-1 shadow-pop [animation-duration:120ms]"
        >
          {options.map((o, i) => {
            ...
            return (
              <li
                ...
                onClick={() => select(i)}
                className={cn(
                  "flex items-center justify-between gap-2 rounded-[calc(var(--radius-input-v)-2px)] px-3 py-2 text-sm",
                  o.disabled
